...
root.title('CardHolders Notepad')
...
def save_file():
    ...
    new_win.title('Save File - CardHolders Notepad')
    ...
    def save_into_db():
        ...
        root.title(name.get() + ' - CardHolders Notepad')
...
def open_file():
    ...
    new_win.title('Open File - CardHolders Notepad')
...
def delete_file():
    ...
    new_win.title('Delete File - CardHolders Notepad')
...
def about_notepad():
    ...
    info = LabelFrame(new_win, text='About CardHolders Notepad', fg='black')

    info.grid(row=0, column=0)

    info_label = Label(info,
                       text='CardHolders Notepad is an app developed by: LinuxDr0pz.\n'
                            ...
                            'Creator - LinuxDr0pz', fg='black', bg='white')
...
def navigation():
    ...
    navigate_label = Label(navigate_frame, text='Welcome to CardHolders Notepad Navigation!\n\n\n'
...
def terms():
    ...
    terms_label = Label(terms_frame, text='Terms And Conditions - CardHolders Notepad\n \n \n \n'
                                          ...
                                          ' Application - CardHolders Notepad\n'
...
help.add_command(label='About CardHolders Notepad', command=about_notepad)
